...
namespace Lab_4_graph
{
    public partial class Form1 : Form
    {
        readonly int N = 50;
        readonly double R = 150;
        ...
        void ReCalculateFigure()
        {
            ...
            figure[figure.Length - 2].X = O.X;
            figure[figure.Length - 2].Y = O.Y;
            double H = 150;
        ...
        private void printFigure(Point3D[] figure, int N, Graphics g)
        {
            ...
            {
                g.FillPolygon(new SolidBrush(Color.Coral), new PointF[] { new PointF((int)figure[i - N].Y, (int)figure[i - N].Z), new PointF((int)figure[N * 2].Y, (int)figure[N * 2].Z), new PointF((int)figure[i - N - 1].Y, (int)figure[i - N - 1].Z) });
